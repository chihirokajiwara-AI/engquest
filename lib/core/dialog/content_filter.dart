...
class ContentFilter {
  ...
  static const List<String> _englishProfanity = [
    ...
    'pussy', 'whore', 'slut', 'damn', 'hell', 'crap', 'piss', 'fag',
    'nigger', 'nigga', 'retard', 'idiot', 'stupid', 'kill', 'rape',
    'murder', 'suicide', 'bomb', 'gun', 'shoot', 'stab', 'sex', 'porn',
    'naked', 'nude', 'breast', 'penis', 'vagina', 'condom', 'drug',
    'weed', 'cocaine', 'heroin', 'meth',
  ];

  /// Common Japanese profanity and offensive terms.
  static const List<String> _japaneseProfanity = [
    'くそ', 'ばか', 'うんこ', 'ちんこ', 'まんこ', 'きもい', 'しね',
    'しにたい', 'ころす', 'きる', 'ころせ', 'うせろ', 'きえろ', 'でていけ',
    'アホ', 'バカ', 'クソ', '死ね', '殺す', '殺せ', 'キモい', 'うざい',
    'ウザい', 'ゴミ', 'クズ', 'ハゲ', 'ブス', 'デブ',
  ];

  /// Violent or self-harm keywords (English, lowercase).
  static const List<String> _violentKeywords = [
    'suicide', 'self-harm', 'selfharm', 'cutting', 'die', 'hang myself',
    'kill myself', 'end my life', 'want to die', 'hate myself',
    'blow up', 'explode', 'terrorist', 'weapon',
  ];

  /// Sexual content keywords (English, lowercase).
  static const List<String> _sexualKeywords = [
    'hentai', 'sexy', 'seduce', 'orgasm', 'masturbat', 'erotic',
    'pornography', 'obscene', 'xxx',
  ];
