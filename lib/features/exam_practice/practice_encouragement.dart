...
const String kWordOrderEncourageMsg = 'なんども まちがえても へいき！ ことばの じゅんばんは'
    'むずかしいよね。「ルールをみる」を つかって、すこしずつ くみたてよう。\n'
    'めいたんていも、てがかりを ならべて 事件（じけん）を とくんだ。';

/// Session-end retention hook: surfaces the streak / daily-goal the child JUST
/// earned at the emotional peak (results screen), in タロ's voice, with a
...
class SessionEndHook extends StatelessWidget {
  ...
  // タロ companion blue for the calm "keep going" state.
  ...
  Widget build(BuildContext context) {
    ...
    // in once (reduced-motion → static). Not-met stays calm タロ-blue, no juice.
    final box = Container(
