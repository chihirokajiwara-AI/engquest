...
const _grade5Part1 = <ListeningItem>[
  ...
  // ── Studio expansion 2026-06-13: 5級 第1部 toward the 25-item target ──────────
  ListeningItem(
    part: 1,
    grade: '5',
    audioKey: 'l5_p1_05.mp3',
    ...
    correctIndex: 0,
    explanation: '「Thank you（ありがとう）」には「You are welcome.（どういたしまして）」とかえすよ。',
  ),
  ListeningItem(
    part: 1,
    grade: '5',
    audioKey: 'l5_p1_06.mp3',
    ...
    correctIndex: 2,
    explanation: '「What time is it?（なんじ?）」には じかんをこたえる「It is three.（3じ）」がいいね。',
  ),
  ListeningItem(
    part: 1,
    grade: '5',
    audioKey: 'l5_p1_07.mp3',
    transcripts: ['Where is my pen?'],
    questionType: ListeningQuestionType.responseSelect,
    question: 'What is the best response?',
    choices: [
      'I am twelve.',
    ...
    correctIndex: 1,
    explanation: '「Where（どこ?）」ときかれたら ばしょをこたえる「It is on the desk.（つくえのうえ）」だよ。',
  ),
  ListeningItem(
    part: 1,
    grade: '5',
    audioKey: 'l5_p1_08.mp3',
    transcripts: ['Do you like apples?'],
    questionType: ListeningQuestionType.responseSelect,
    question: 'What is the best response?',
    choices: [
      'It is sunny.',
    ...
    correctIndex: 3,
    explanation: '「Do you like 〜?」には「Yes, I do.（うん、すき）」とこたえるよ。',
  ),
  ListeningItem(
    part: 1,
    grade: '5',
    audioKey: 'l5_p1_09.mp3',
    transcripts: ['Let us play soccer.'],
    questionType: ListeningQuestionType.responseSelect,
    question: 'What is the best response?',
    choices: [
      'Sounds good!',
    ...
    correctIndex: 0,
    explanation:
        'さそい「Let us play soccer.（サッカーしよう）」には「Sounds good!（いいね!）」とこたえるよ。',
  ),
];
...
const _grade5Part2 = <ListeningItem>[
  ...
  ListeningItem(
    ...
    questionType: ListeningQuestionType.dialogueContent,
    question: 'Where is the boy going?',
    choices: [
      'To the library.',
      'To the park.',
      'To the store.',
    ...
    correctIndex: 1,
    explanation: 'おとこのこは「I am going to the park.（こうえんにいく）」といっているよ。',
  ),
  ListeningItem(
    part: 2,
    grade: '5',
  ...
  ListeningItem(
    ...
    questionType: ListeningQuestionType.dialogueContent,
    question: 'What subject does the boy like?',
    choices: [
      'Math.',
      'English.',
      'Science.',
    ...
    correctIndex: 2,
    explanation: 'おとこのこは「I like science.（りかがすき）」といっているよ。math（さんすう）はすきじゃないね。',
  ),
  // ── Studio expansion 2026-06-13: 5級 第2部 toward the 25-item target ──────────
  ListeningItem(
    part: 2,
    grade: '5',
    audioKey: 'l5_p2_05.mp3',
    transcripts: [
      'A: How many pencils do you have?',
      'B: I have three.',
    ],
    questionType: ListeningQuestionType.dialogueContent,
    question: 'How many pencils does the boy have?',
    choices: [
      'One.',
      'Two.',
      'Three.',
    ...
    correctIndex: 2,
    explanation: 'B は「I have three.（3ぼん）」といっているね。',
  ),
  ListeningItem(
    part: 2,
    grade: '5',
    audioKey: 'l5_p2_06.mp3',
    transcripts: [
      'A: What sport do you like?',
      'B: I like tennis.',
    ],
    questionType: ListeningQuestionType.dialogueContent,
    question: 'What sport does the boy like?',
    choices: [
      'Tennis.',
      'Soccer.',
      'Baseball.',
    ...
    correctIndex: 0,
    explanation: 'B は「I like tennis.（テニスがすき）」といっているね。',
  ),
  ListeningItem(
    part: 2,
    grade: '5',
    audioKey: 'l5_p2_07.mp3',
    transcripts: [
      'A: Where do you live?',
    ...
    correctIndex: 3,
    explanation: 'B は「I live near the park.（こうえんのちかく）」といっているね。',
  ),
  ListeningItem(
    part: 2,
    grade: '5',
    audioKey: 'l5_p2_08.mp3',
    transcripts: [
      'A: What is your favorite color?',
      'B: My favorite color is blue.',
    ],
    questionType: ListeningQuestionType.dialogueContent,
    question: 'What color does the boy like?',
    choices: [
      'Red.',
      'Green.',
      'Blue.',
    ...
    correctIndex: 2,
    explanation: 'B は「My favorite color is blue.（あおがすき）」といっているね。',
  ),
  ListeningItem(
    part: 2,
    grade: '5',
    audioKey: 'l5_p2_09.mp3',
    transcripts: [
      'A: When is the test?',
      'B: It is on Friday.',
    ],
    ...
    correctIndex: 1,
    explanation: 'B は「It is on Friday.（きんようび）」といっているね。',
  ),
];
...
const _grade5Part3 = <ListeningItem>[
  ...
  // ── Studio expansion 2026-06-13: 5級 第3部 toward the 25-item target ──────────
  ListeningItem(
    part: 3,
    grade: '5',
    audioKey: 'l5_p3_05.mp3',
    transcripts: [
      'I am Ken. I am eleven years old. I like baseball. I play it every Sunday.',
    ],
    questionType: ListeningQuestionType.passageContent,
    question: 'When does Ken play baseball?',
    choices: [
      'Every Monday.',
      'Every Saturday.',
      'Every Sunday.',
    ...
    correctIndex: 2,
    explanation: 'はなしては「I play it every Sunday.（まいしゅう にちようび）」といっているね。',
  ),
  ListeningItem(
    part: 3,
    grade: '5',
    audioKey: 'l5_p3_06.mp3',
    transcripts: [
      'This is my dog. His name is Max. He is big and brown. He likes to run in the park.',
    ],
    questionType: ListeningQuestionType.passageContent,
    ...
    correctIndex: 1,
    explanation: 'はなしては「He is big and brown.（ちゃいろ）」といっているね。',
  ),
  ListeningItem(
    part: 3,
    grade: '5',
    audioKey: 'l5_p3_07.mp3',
    transcripts: [
      'Hello. I am Aya. I have two brothers. We go to school by bus every day.',
    ],
    questionType: ListeningQuestionType.passageContent,
    question: 'How does Aya go to school?',
    choices: [
      'By car.',
      'By train.',
      'On foot.',
    ...
    correctIndex: 3,
    explanation: 'はなしては「We go to school by bus.（バスで）」といっているね。',
  ),
];
...
const _grade4Part2 = <ListeningItem>[
  ...
  ListeningItem(
    ...
    questionType: ListeningQuestionType.dialogueContent,
    question: 'What is the boy going to do this weekend?',
    choices: [
      'Study for exams.',
      'Play in a soccer tournament.',
      'Visit his grandparents in Osaka.',
  ...
  ListeningItem(
    ...
    questionType: ListeningQuestionType.dialogueContent,
    question: 'Why did the boy miss practice?',
    choices: [
...
const _gradePre2Part2 = <ListeningItem>[
  ...
  ListeningItem(
    ...
    transcripts: [
      ...
      'Question: What does the girl plan to do during her gap year?',
    ],
    questionType: ListeningQuestionType.dialogueQA,
    question: 'What does the girl plan to do during her gap year?',
    choices: [
  ...
  ListeningItem(
    ...
    transcripts: [
      ...
      'Question: What two majors is the boy considering?',
    ],
    questionType: ListeningQuestionType.dialogueQA,
    question: 'What two majors is the boy considering?',
    choices: [
  ...
  ListeningItem(
    ...
    transcripts: [
      ...
      'Question: Which club will the boy most likely choose?',
    ],
    questionType: ListeningQuestionType.dialogueQA,
    question: 'Which club will the boy most likely choose?',
    choices: [
  ...
  ListeningItem(
    ...
    transcripts: [
      ...
      'Question: When does the girl plan to work?',
    ],
    questionType: ListeningQuestionType.dialogueQA,
    question: 'When does the girl plan to work?',
    choices: [
  ...
  ListeningItem(
    ...
    transcripts: [
      ...
      'Question: Why does the boy like the app?',
    ],
    questionType: ListeningQuestionType.dialogueQA,
    question: 'Why does the boy like the app?',
    choices: [
      ...
      'It reminds him to review words every day.',
    ],
    correctIndex: 3,
    explanation:
...
const _grade2Part1 = <ListeningItem>[
  ...
  ListeningItem(
    ...
    transcripts: [
      ...
      'Question: What benefit does the woman mention about working from home?',
    ],
    questionType: ListeningQuestionType.dialogueQA,
    question: 'What benefit does the woman mention about working from home?',
    choices: [
  ...
  ListeningItem(
    ...
    transcripts: [
      ...
      'Question: What does the woman suggest to protect personal data?',
    ],
    questionType: ListeningQuestionType.dialogueQA,
    question: 'What does the woman suggest to protect personal data?',
    choices: [
  ...
  ListeningItem(
    ...
    transcripts: [
      ...
      'Question: What does the man enjoy about his job?',
    ],
    questionType: ListeningQuestionType.dialogueQA,
    question: 'What does the man enjoy about his job?',
    choices: [
...
const _gradePre2PlusPart1 = <ListeningItem>[
  ...
  ListeningItem(
    ...
    transcripts: [
      ...
      'Question: Which bus should the woman take to the station?',
    ],
    questionType: ListeningQuestionType.dialogueQA,
    question: 'Which bus should the woman take to the station?',
    choices: [
  ...
  ListeningItem(
    ...
    transcripts: [
      ...
      'Question: Which club will the girl join?',
    ],
    questionType: ListeningQuestionType.dialogueQA,
    question: 'Which club will the girl join?',
    choices: [
...
const _gradePre1Part1 = <ListeningItem>[
  ...
  ListeningItem(
    ...
    transcripts: [
      ...
      'Question: Which candidate does the man favor?',
    ],
    questionType: ListeningQuestionType.dialogueQA,
    question: 'Which candidate does the man favor?',
    choices: [
