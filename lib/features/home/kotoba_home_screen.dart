...
// kGradeVocabIdPrefix + gradeScopedDueCount moved to core/fsrs/grade_due.dart
// (shared with the battle session-end "due tomorrow" hook; home imports battle,
// so the shared util cannot live in either screen).
