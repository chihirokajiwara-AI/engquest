...
const List<QuestTown> kQuestTowns = [
  ...
  QuestTown(
    ...
    intro: '社会（しゃかい）の港町（みなとまち）。世（よ）の中（なか）を語（かた）り合（あ）う場所（ばしょ）。'
        ...
        '小（ちい）さなおとうとを傷（きず）つけてしまってから、わざと だまっているのだ。\n'
  ...
  QuestTown(
    ...
    cleared: '橋守（はしもり）ロウは、灯（あか）りを掲（かか）げたまま動（うご）かない――けれど、'
        ...
        '橋守（はしもり）ロウが、はじめて灯（あか）りを下（お）ろして言（い）う――「のこる石（いし）はあと二（ふた）つ。さいごの ひろばに、しずけさ〈サイレント〉が いる」。',
    encounters: [
  ...
  QuestTown(
    ...
    intro: '学者（がくしゃ）の城下町（じょうかまち）。学問（がくもん）とビジネスの言葉（ことば）が交（か）わされる町（まち）。\n'
        ...
        '正（ただ）しい言（こと）づかい（仮定法（かていほう）・論（ろん）の運（はこ）び）で彼（かれ）と論（ろん）じ合（あ）い、六（むっ）つ目（め）の〈声（こえ）の石（いし）〉をとり戻（もど）そう。',
    cleared: '学士（がくし）オーレンは、静（しず）かに門（もん）をひらいた――'
        '「私（わたし）は まちがっていた。沈黙（ちんもく）は、安全（あんぜん）などではなかった」。\n'
        '六（むっ）つ目（め）の〈声（こえ）の石（いし）〉を手（て）に。のこるは あと ひとつ――ことばが はじまった、灰色（はいいろ）の ひろばに。\n'
  ...
  QuestTown(
    ...
    cleared: 'あなたの言葉（ことば）が、アイラの胸（むね）に そっと とどいた。なくしていた「声（こえ）」が、アイラに もどってくる。'
        '灰色（はいいろ）の ひろばに 色（いろ）が あふれ、その色（いろ）は はしを わたり、すべての まちへ ながれていく。だれも やっつけなかった。ただ、アイラは もう ひとりじゃない。\n'
        '七（なな）つ目（め）――さいごの〈声（こえ）の石（いし）〉が、アイラの こえと ともに もどった。むねの石（いし）と あわせ、〈ことばの紋章（もんしょう）〉が かんせいする。それは、きみが すべての こえを かえしてきた、たしかな あかし。\n'
        'あなたは 世界（せかい）に ──そして アイラに── ことばの かえしかたを、おもいださせたんだ。',
    encounters: [
