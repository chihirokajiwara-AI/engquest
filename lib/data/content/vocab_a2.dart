// lib/data/content/vocab_a2.dart
// ENG Quest — A2 (英検4級) vocabulary: 300 words
//
// CEFR A2 covers everyday situations: travel, shopping, daily routines,
// simple descriptions, and basic social interactions.

import '../../core/models/vocab_item.dart';

/// 300 A2-level vocabulary items (英検4級).
const List<VocabItem> kSeedVocabA2 = [
  // ── Daily Life / Home (001–030) ──
  VocabItem(
      id: 'eiken4_001',
      word: 'kitchen',
      reading: 'キッチン',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'My father waters the garden every evening.'
      ],
      distractors: [
        'きゅうか',
        'とくべつな',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'I can see the garden from this window.'
      ],
      distractors: [
        'たびをする',
        'でんとう',
  ...
  VocabItem(
      ...
      exampleSentences: ['The roof is red.', 'Rain falls on the roof.'],
      distractors: ['かぎ', 'どうぶつえん', 'のりおくれる']),
  VocabItem(
      id: 'eiken4_010',
      word: 'stairs',
      reading: 'ステアーズ',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'My family eats together in the living room.'
      ],
      distractors: [
        'まちがい',
        'きめる',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'I sleep with a warm blanket.',
        'She put the blanket on the baby.'
      ],
      distractors: [
        'ノート',
        'ゆうごはん',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'Dad parks the car in the garage.',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'The pipe under the sink is broken.'
      ],
      distractors: [
        'こうずい',
        'おうえんする',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'We learn English in this classroom.'
      ],
      distractors: [
        'つかう',
        'こたえ',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'My school schedule starts at eight.',
        'Please check your schedule for today.'
      ],
      distractors: [
        'たいいくかん',
        'じんじゃ',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'The English lesson was fun today.',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'I wrote a report about animals.',
        'The teacher asked us to write a report.'
      ],
      distractors: [
        'わかす',
        'やくにたつ',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'Our group project is about the ocean.',
        'We worked on the science project together.'
      ],
      distractors: [
        'りか',
        'かのうな',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'My pencil case has many colors.',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'We use an English-Japanese dictionary.'
      ],
      distractors: [
        'はいた',
        'やってみる',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'The answer to question three is B.'
      ],
      distractors: [
        'あんぜんな',
        'うるさい',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'I joined the science club at school.',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'I made new friends this semester.'
      ],
      distractors: [
        'はし',
        'ちず',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'We have summer vacation in August.',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'Please copy what is on the blackboard.'
      ],
      distractors: [
        'あんぜんな',
        'ひので',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'We have PE class in the gymnasium.',
        'The school gymnasium is very large.'
      ],
      distractors: [
        'かんじる',
        'かりる',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'The cafeteria serves many kinds of food.'
      ],
      distractors: [
        'きをつけて',
        'すいそくする',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'Her suitcase is red and has wheels.'
      ],
      distractors: [
        'かんけい',
        'のりおくれる',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'Please be at the gate before departure.'
      ],
      distractors: [
        'おやすみ',
        'フォーク',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'We celebrated his arrival at the airport.'
      ],
      distractors: [
        'もり',
        'かのうな',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'Wait on platform three for your train.',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'We prayed at the shrine on New Year.',
        'The shrine has a red gate.'
      ],
      distractors: [
        'かべ',
        'こたえ',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'We visited a beautiful castle in Japan.',
        'The castle stands on top of a hill.'
      ],
      distractors: [
        'ゆうびんきょく',
        'かくれる',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'The amusement park is very exciting.'
      ],
      distractors: [
        'おくる',
        'じしん',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'Mom shops at the supermarket every week.',
        'The supermarket has many kinds of fruit.'
      ],
      distractors: [
        'いそぐ',
        'おなかがいたい',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'I sent a letter from the post office.',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'Dad went to the bank to get money.',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'I heard loud thunder during the rain.',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'We climbed the mountain on Sunday.'
      ],
      distractors: [
        'しょくじせいげん',
        'きせつ',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'We walked through the forest on a trail.'
      ],
      distractors: [
        'ソース',
        'やさい',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'We went on a boat to the small island.'
      ],
      distractors: [
        'あせ',
        'じゅぎょう',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'The coast is beautiful in summer.'
      ],
      distractors: [
        'さんかする',
        'たいくつな',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'The valley is green and peaceful.',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'The sunrise was beautiful and orange.'
      ],
      distractors: [
        'やってみる',
        'やさい',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'A cool breeze came from the ocean.',
        'I enjoy the morning breeze.'
      ],
      distractors: [
        'はいしゃ',
        'がっき',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'We practiced earthquake safety at school.'
      ],
      distractors: [
        'やくにたつ',
        'じんじゃ',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'The soil in this field is rich.'
      ],
      distractors: [
        'ゆうやけ',
        'やさい',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'I followed the recipe to make cookies.',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'We need three ingredients for this dish.',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'I eat lunch at school with my friends.',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'Please bring me a bowl of rice.'
      ],
      distractors: [
        'かんけい',
        'こわがっている',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'Please get a spoon from the drawer.'
      ],
      distractors: [
        'くも',
        'しょうかいする',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'Please set the fork on the left side.'
      ],
      distractors: [
        'あらし',
        'さみしい',
  ...
  VocabItem(
      ...
      exampleSentences: ['He fried the chicken in oil.', 'I love fried rice.'],
      distractors: ['おやすみ', 'とどける', 'まくら']),
  VocabItem(
      id: 'eiken4_132',
      word: 'bake',
      reading: 'ベイク',
      ...
      exampleSentences: [
        ...
        'I want to bake cookies this weekend.'
      ],
      distractors: [
        'ちゅうもんする',
        'いけ',
  ...
  VocabItem(
      ...
      exampleSentences: ['Please slice the bread.', 'I want a slice of cake.'],
      distractors: ['たもつ', 'ゆうき', 'ビタミン']),
  VocabItem(
      id: 'eiken4_134',
      word: 'flavor',
      reading: 'フレーバー',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'This portion is very large.',
        'Please give me a small portion.'
      ],
      distractors: [
        'びょういん',
        'きょうしつ',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'The chopstick rest is shaped like a fish.'
      ],
      distractors: [
        'ひとりぶん',
        'まくら',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'She went to the hospital for her checkup.',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'Drink warm water for a stomachache.'
      ],
      distractors: [
        'レストラン',
        'はいしゃ',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'I have a checkup at the doctor today.',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'I have a bad toothache today.',
        'I went to the dentist for my toothache.'
      ],
      distractors: [
        'だいどころ',
        'しょうじょう',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'Mom took me to the clinic this morning.',
        'The clinic is open until 6 PM.'
      ],
      distractors: [
        'おこっている',
        'でる',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'The wound healed after one week.'
      ],
      distractors: [
        'レシピ',
        'かいがん',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'The hospital has wheelchairs near the entrance.'
      ],
      distractors: [
        'せつめいする',
        'せいこうする',
  ...
  // ── People / Emotions (166–190) ──
  VocabItem(
      id: 'eiken4_166',
      word: 'angry',
      reading: 'アングリー',
      jpTranslation: 'おこっている',
      cefrLevel: CefrLevel.a2,
      eikenLevel: '4',
      pos: [
        PartOfSpeech.adjective
      ...
      exampleSentences: [
        'He was angry when he lost the game.',
        'Do not get angry over small things.'
      ],
      distractors: [
        'メニュー',
        'ちかてつ',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'She was very excited to see her friend.'
      ],
      distractors: [
        'くも',
        'あぶない',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'The brave girl helped the lost cat.',
        'You need to be brave for the injection.'
      ],
      distractors: [
        'まなぶ',
        'うるさい',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'She felt nervous on the first day.'
      ],
      distractors: [
        'さしだす',
        'とくべつな',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'Please stay calm in an emergency.',
        'She has a calm and kind voice.'
      ],
      distractors: [
        'ゆうえんち',
        'もどる',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'He was too shy to speak in class.'
      ],
      distractors: [
        'ちがう',
        'みせる',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'His cheerful smile made me happy.'
      ],
      distractors: [
        'ずつう',
        'ひっぱる',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'It is good to talk about your emotions.',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'She had the courage to sing on stage.'
      ],
      distractors: [
        'あさごはん',
        'せつめいする',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'We helped our neighbor move boxes.'
      ],
      distractors: [
        'でる',
        'けとばす',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'Teenagers often enjoy music and games.'
      ],
      distractors: [
        'きせつ',
        'まける',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'Adults need to work to earn money.',
        'Ask an adult for help if you are lost.'
      ],
      distractors: [
        'しんしつ',
        'しぜんな',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'Please give your seat to elderly people.',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'Every citizen must follow the rules.',
        'She is a proud citizen of Japan.'
      ],
      distractors: [
        'しずかな',
        'おそい',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'We all help our community.',
        'The community center has many programs.'
      ],
      distractors: [
        'サインする',
        'つち',
  ...
  // ── Action Verbs (191–230) ──
  VocabItem(
      id: 'eiken4_191',
      word: 'arrive',
      reading: 'アライブ',
      jpTranslation: 'とうちゃくする',
      cefrLevel: CefrLevel.a2,
      eikenLevel: '4',
      pos: [
        PartOfSpeech.verb
  ...
  VocabItem(
      ...
      eikenLevel: '4',
      pos: [PartOfSpeech.verb],
      exampleSentences: ['I believe in you.', 'Do you believe in magic?'],
      distractors: ['おとす', 'きんちょうしている', 'そだつ']),
  VocabItem(
      id: 'eiken4_193',
      word: 'borrow',
      reading: 'ボロウ',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'He carried the heavy bag for me.',
        'Can you carry this box, please?'
      ],
      distractors: [
        'にんきのある',
        'カーテン',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'She discovered a shortcut to school.'
      ],
      distractors: [
        'いそぐ',
        'わくわくしている',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'He earns money by helping his neighbor.',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'We all enjoyed the school festival.'
      ],
      distractors: [
        'しんらい',
        'がけ',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'He escaped the danger just in time.'
      ],
      distractors: [
        'たに',
        'しんしつ',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'Her score improved a lot this time.'
      ],
      distractors: [
        'かりる',
        'はいる',
  ...
  VocabItem(
      ...
      eikenLevel: '4',
      pos: [PartOfSpeech.verb],
      exampleSentences: ['We lost the game today.', 'Do not lose your ticket.'],
      distractors: ['やってみる', 'やさしい', 'ゆか']),
  VocabItem(
      id: 'eiken4_218',
      word: 'miss',
      reading: 'ミス',
      jpTranslation: 'のりおくれる',
      cefrLevel: CefrLevel.a2,
      eikenLevel: '4',
      pos: [
        PartOfSpeech.verb
  ...
  VocabItem(
      ...
      eikenLevel: '4',
      pos: [PartOfSpeech.verb],
      exampleSentences: ['Please pass the salt.', 'I passed my English exam!'],
      distractors: ['からの', 'とうふ', 'しずかな']),
  VocabItem(
      id: 'eiken4_222',
      word: 'pick',
      reading: 'ピック',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'I prepared my bag the night before.',
        'Let us prepare for the school festival.'
      ],
      distractors: [
        'けしごむ',
        'くすり',
  ...
  VocabItem(
      ...
      word: 'promise',
      reading: 'プロミス',
      jpTranslation: 'やくそくする',
      cefrLevel: CefrLevel.a2,
      eikenLevel: '4',
      pos: [PartOfSpeech.verb, PartOfSpeech.noun],
      exampleSentences: ['I promise to be on time.', 'Keep your promise.'],
      distractors: ['メニュー', 'まなぶ', 'しんせんな']),
  VocabItem(
      id: 'eiken4_226',
      word: 'protect',
      reading: 'プロテクト',
      ...
      exampleSentences: [
        ...
        'She protected her little brother.'
      ],
      distractors: [
        'えらぶ',
        'きんちょうしている',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'She reminded me to bring my lunch.'
      ],
      distractors: [
        'ねつ',
        'さまざまな',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'I invited my friends to my birthday.',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'I joined the art club this year.'
      ],
      distractors: [
        'わすれる',
        'メニュー',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'This shirt matches your pants well.'
      ],
      distractors: [
        'しょうじょう',
        'フォーク',
  ...
  VocabItem(
      ...
      word: 'order',
      reading: 'オーダー',
      jpTranslation: 'ちゅうもんする',
      cefrLevel: CefrLevel.a2,
      eikenLevel: '4',
      pos: [PartOfSpeech.verb, PartOfSpeech.noun],
      exampleSentences: ['I ordered a pizza online.', 'May I take your order?'],
      distractors: ['えき', 'もり', 'きゅうそく']),
  VocabItem(
      id: 'eiken4_243',
      word: 'pay',
      reading: 'ペイ',
      ...
      eikenLevel: '4',
      pos: [PartOfSpeech.verb],
      exampleSentences: ['I paid for the lunch.', 'How would you like to pay?'],
      distractors: ['えき', 'かのうな', 'にじ']),
  VocabItem(
      id: 'eiken4_244',
      word: 'repeat',
      reading: 'リピート',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'Save your work before you close the computer.'
      ],
      distractors: [
        'こうちょうせんせい',
        'さばく',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'I searched for my lost key.',
        'Let us search the internet for information.'
      ],
      distractors: [
        'ざいりょう',
        'じゅうだいのこ',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'Please share the cookies with your friends.',
        'We shared the work between us.'
      ],
      distractors: [
        'はくぶつかん',
        'ずつう',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'A smile can make someone feel better.'
      ],
      distractors: [
        'ゆか',
        'せまい',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'Our teacher teaches English very well.'
      ],
      distractors: [
        'まちなか',
        'プラットホーム',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'We traveled to Kyoto last summer.'
      ],
      distractors: [
        'くうこう',
        'すばらしい',
  ...
  VocabItem(
      ...
      eikenLevel: '4',
      pos: [PartOfSpeech.verb],
      exampleSentences: ['May I use your pen?', 'Use a map to find the way.'],
      distractors: ['せつめいする', 'ひっぱる', 'ちゅうしゃ']),
  VocabItem(
      id: 'eiken4_263',
      word: 'visit',
      reading: 'ビジット',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'She is a careful and quiet student.'
      ],
      distractors: [
        'しろ',
        'おやつ',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'It is dangerous to play near the river.',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'These two shoes look different.'
      ],
      distractors: [
        'ふろば',
        'かくれる',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'There are no students. The room is empty.'
      ],
      distractors: [
        'あわせる',
        'ほうたい',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'The classroom is very noisy today.',
        'Please do not be so noisy.'
      ],
      distractors: [
        'しょくどう',
        'にている',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'Is it possible to finish by noon?',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'He is a serious and hardworking student.'
      ],
      distractors: [
        'おうえんする',
        'しずかな',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'The turtle is slow but never gives up.',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'There are various kinds of fish in the sea.',
  ...
  VocabItem(
      ...
      exampleSentences: ['What a wonderful view!', 'She did a wonderful job.'],
      distractors: ['ほほえむ', 'しつもん', 'あわせる']),
  VocabItem(
      id: 'eiken4_288',
      word: 'afraid',
      reading: 'アフレイド',
      jpTranslation: 'こわがっている',
      cefrLevel: CefrLevel.a2,
      eikenLevel: '4',
      pos: [
        PartOfSpeech.adjective
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'She has an amazing talent for drawing.'
      ],
      distractors: [
        'くるまいす',
        'がっき',
  ...
  VocabItem(
      ...
      eikenLevel: '4',
      pos: [PartOfSpeech.adjective],
      exampleSentences: ['This movie is boring.', 'Waiting in line is boring.'],
      distractors: ['おどろいている', 'もつ', 'つかう']),
  VocabItem(
      id: 'eiken4_291',
      word: 'clean',
      reading: 'クリーン',
      ...
      exampleSentences: [
        ...
        'The river water is clean and clear.'
      ],
      distractors: [
        'おなかがいたい',
        'かんじる',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'I like fresh vegetables from the garden.',
  ...
  VocabItem(
      ...
      word: 'modern',
      reading: 'モダン',
      jpTranslation: 'げんだいてきな',
      cefrLevel: CefrLevel.a2,
      eikenLevel: '4',
      pos: [PartOfSpeech.adjective],
      exampleSentences: ['This is a modern building.', 'She likes modern art.'],
      distractors: ['りか', 'みたす', 'まつ']),
  VocabItem(
      id: 'eiken4_295',
      word: 'narrow',
      reading: 'ナロウ',
      ...
      exampleSentences: [
        ...
        'The hallway is too narrow for two people.'
      ],
      distractors: [
        'だいどころ',
        'あんぜんな',
  ...
  VocabItem(
      ...
      exampleSentences: [
        'This juice has a natural flavor.',
        'Japan has beautiful natural scenery.'
      ],
      distractors: [
        'うまくなる',
        'てんじょう',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'She likes simple and clean designs.'
      ],
      distractors: [
        'やさい',
        'とくべつな',
  ...
  VocabItem(
      ...
      exampleSentences: [
        ...
        'There is a tiny bug on the flower.'
      ],
      distractors: [
        'おなかがいたい',
        'やくそくする',
