...
|48|世界/物語実装|22|BUILD|implement STORY-BIBLE 7-case arc into quest_data (currently 英検+thin skin)|
|49|キャラ in-game|12|BUILD|cast dialogue, arcs, presence (bible→code); art-gen separate|
|50|探索の深さ|31|BUILD|scene/nazo/hotspot depth → Layton/Minecraft-grade|
